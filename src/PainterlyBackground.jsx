  ...
  const color =
    ...
    (typeof window !== "undefined" &&
      (getComputedStyle(document.documentElement)
        ...
        .trim() ||
        localStorage.getItem("ph.baseColor"))) ||
    "#0B0F1A";
...
const setVHVar = () => {
  ...
  return (
    <>
      {/* keep your base layer exactly as you had it */}
      <div
        className="pbg-layer fixed inset-0 -z-20 pointer-events-none"
        style={{
          background:
      ...
      <canvas
        ref={ref}
        className="pbg-canvas fixed inset-0 -z-10 pointer-events-none"
      />
