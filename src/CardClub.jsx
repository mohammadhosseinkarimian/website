// CardClub.jsx — playing card (Clubs) using react-icons luxe club
import React from "react";
import ClubIconLux from "./ClubIconLux";
...
/* ===== PUBLIC: CardClub (A,K,Q,J only — no 10) ===== */
export default function CardClub({ rank = "A", title, caption, fill = false }) {
  const R = rank;
  ...
  return (
    <div className="deck-card" style={wrapperStyle}>
      <div style={{ position: "absolute", inset: 8 }}>
        ...
        {/* no 10 layout for clubs by request */}
